...
import pc3d.main_preprocess_kinetics as trainer
import submitit
...
def parse_args():
    ...
    parser.add_argument("--nodes", default=20, type=int, help="Number of nodes to request")
    parser.add_argument("--timeout", default=60 * 24, type=int, help="Duration of the job")
    parser.add_argument("--job_dir", default="", type=str, help="Job dir. Leave empty for automatic.")

    parser.add_argument("--name", type=str)
    parser.add_argument("--partition", default="lowpri", type=str, help="Partition where to submit")
