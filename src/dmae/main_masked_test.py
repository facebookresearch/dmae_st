...
from mae.engine_test import test
from mae.util.meters import TestMeter
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument( "--decoder_device", default="cpu", type=str, )
    # Dataset parameters
    parser.add_argument( "--decoder_backend", default="torchvision", type=str, )
    parser.add_argument("--no_qkv_bias", action="store_true")
    parser.add_argument("--sep_pos_embed", action="store_true")
    parser.add_argument( "--fp32", action="store_true", )
    parser.add_argument("--cls_embed", action="store_true")
    parser.add_argument("--num_retries", default=12, type=int,
                        help="number of retries when loading data")
    return parser
...
def main(args):
    ...
    for testset in [False, True]: 
        dataset_test = KineticsBbox(
            mode="test" if not testset else "testset",
            path_to_data_dir=("/datasets01/kinetics/092121/400" if not testset else "/datasets01/kinetics_400/k400"),
