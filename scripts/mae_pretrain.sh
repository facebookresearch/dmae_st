...
#     --tasks_per_node=8 --nodes=8 --exclude="" \
...
# python src/mae_submitit_pretrain.py --job_dir="experiments/mae-st/MAE_ST-200epochs-k400v2-288px" \
#     --nodes=8 --tasks_per_node=8 --exclude="" \
