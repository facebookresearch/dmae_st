...
class DirectedMaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder(self, x, binary_map, mask_ratio):
        # embed patches
        ...
        if self.mask_type == "directed":
            ...
            patch_weights = torch.softmax(patch_binary_map[..., 0] / self.temperature,
    ...
    def forward(self, imgs, binary_map=None, mask_ratio=0.75, visualize=False):
        latent, mask, ids_restore = self.forward_encoder(imgs, binary_map, mask_ratio)
