...
# python src/mae_submitit_linprobe.py --job_dir="experiments/dmae-st/DMAE_ST-200epochs-TempCos150_050/linprobe-frac100-repeat2" \
#     --nodes=6 --exclude="" \
...
# python src/mae_submitit_linprobe.py --job_dir="experiments/dmae-st/DMAE_ST-200epochs-curriculum-flip_mask/linprobe-frac100-repeat2" \
#     --nodes=6 --exclude="" \
#     --partition=lowpri --account=all \
#     --distributed \
#     --epochs=50 --warmup_epochs=5 --dist_eval \
...
python src/mae_submitit_linprobe.py --job_dir="experiments/dmae-st/8x8A100-DMAE_ST-default/linprobe-frac100-repeat2" \
    --nodes=6 --exclude="" \
    --partition=lowpri --account=all \
    --distributed \
    --epochs=50 --warmup_epochs=5 --dist_eval \
