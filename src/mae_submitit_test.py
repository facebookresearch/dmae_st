...
import mae.main_test as trainer
import submitit
...
def parse_args():
    ...
    parser.add_argument("--account", type=str, help="Do not set if not meant to be used.")

    parser.add_argument("--partition", default="hipri", type=str, help="Partition where to submit")
    parser.add_argument("--account", default="all", type=str, help="slurm account")
