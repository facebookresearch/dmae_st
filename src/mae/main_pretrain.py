...
def get_args_parser():
    ...
    parser.add_argument("--mask_type", default="st",type=str,
    ...
    parser.add_argument("--k400v2", action="store_true",
                        help="TEMP VARIABLE for testing if k400 v2 is the same.")
        ...
        if args.output_dir and (
            ...
            for retry_count in range(3):
                try:
                    ...
                    print(f"Save error {e} on attempt {retry_count}.")
                    continue
