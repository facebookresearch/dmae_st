...
from image_dmae.util.imagenet_bbox import ImagenetBbox
import mae.util.misc as misc
from mae.util.misc import NativeScalerWithGradNormCount as NativeScaler

# from image_dmae import models_mae_image as models_mae
from image_dmae import models_dmae_image as models_dmae

from image_dmae.engine_pretrain import train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--data_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--bbox_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
...
def main(args):
    ...
    dataset_train = ImagenetBbox(os.path.join(args.data_path, "train"),
                                 args.bbox_path,
